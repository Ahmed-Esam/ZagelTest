...
export class apiService {
  ...
  getStories () :Observable<any>{
    ...
    getAllSection(){
      const headers = { 'Content-type':'application/json', 'DeviceToken':'62447fb2f241da48', 'AuthToken':'AKQi8yzdDa' }
      return this.http.get<any>(`http://apitest.thezagelapp.com/api/News/GetAllSection/3574/20`, { headers })
    }

    // http://apitest.thezagelapp.com/api/News/GetAllSource/3574/0
    getAllSource(){
      const headers = { 'Content-type':'application/json', 'DeviceToken':'62447fb2f241da48', 'AuthToken':'AKQi8yzdDa' }
      return this.http.get<any>(`http://apitest.thezagelapp.com/api/News/GetAllSource/3574/0`, { headers })
